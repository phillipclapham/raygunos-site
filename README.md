...
Framework content lives in `/Documents/raygun-os/RAYGUN.md` (v4.7.1) — this is the source of truth. The website renders that content with visual polish and interactive elements.
